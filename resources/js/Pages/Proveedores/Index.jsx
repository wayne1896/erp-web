                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500">Proveedores Locales</p>
                                    <p className="text-2xl font-bold">{stats.locales}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500">Proveedores Internacionales</p>
                                    <p className="text-2xl font-bold">{stats.internacionales}</p>
                                </div>
                            </div>
                        </div>
                    </div>
