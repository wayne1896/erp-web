// resources/js/Pages/Proveedores/Create.jsx
import React from 'react';
import AuthenticatedLayout from '@/Layouts/AuthenticatedLayout';
import { Head, Link, useForm } from '@inertiajs/react';
import { ArrowLeft, Save, Building, Globe, Phone, Mail, MapPin, User, CreditCard } from 'lucide-react';
...
export default function Create({ auth, tipos_proveedor, provincias }) {
    ...
    const formatRNC = (value) => {
        ...
        // Formatear mientras se escribe (1-01-23456-9)
    ...
    const handleRNCChange = (value) => {
        // Limpiar el formato para guardar solo números
        const cleaned = value.replace(/\D/g, '');
        setData('rnc', cleaned);
    };
