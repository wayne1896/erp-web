        ...
        >
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {ultimaCaja && (
                        <div className="mb-8 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6">
                            <div className="flex items-start">
                                <History className="w-6 h-6 text-blue-600 mr-3 mt-1" />
                                <div className="flex-1">
                                    <h3 className="font-bold text-blue-800 mb-2">Última caja registrada</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            <p className="text-sm text-blue-700">Monto inicial:</p>
                                            <p className="font-bold text-blue-900">
                                                {formatCurrency(ultimaCaja.monto_inicial)}
                                            </p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-blue-700">Fecha apertura:</p>
                                            <p className="font-bold text-blue-900">
                                                {new Date(ultimaCaja.fecha_apertura).toLocaleDateString('es-ES')}
                                            </p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-blue-700">Hora apertura:</p>
                                            <p className="font-bold text-blue-900">
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="text-lg font-bold text-gray-800">Configuración de apertura</h3>
                                    <p className="text-sm text-gray-600">Ingresa el monto inicial para abrir caja</p>
                                </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="p-6">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            step="0.01"
                                            min="0"
                                            className={`block w-full pl-12 pr-12 py-3 text-lg border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 ${
                                    ...
                                    {errors.monto_inicial && (
                                        <p className="mt-1 text-sm text-red-600">{errors.monto_inicial}</p>
                                    )}
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-xl p-4 mb-6">
                                    <h4 className="font-bold text-green-800 mb-3">Resumen</h4>
                                    <div className="space-y-2">
                                        ...
                                        <div className="border-t border-green-200 pt-2">
                                            <div className="flex justify-between items-center">
                                                <span className="text-green-700">Total en caja:</span>
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4">
                                    <Link
                                        ...
                                        className="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition w-full sm:w-auto justify-center"
                                    >
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4">
                            <h4 className="font-bold text-blue-800 mb-2">Procedimiento</h4>
